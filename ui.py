...
class UI():
    ...
    def gameState(self, channel):
            ...
            while True:
                ...
                # Score conditions
                if RenderSet['ball'].x >= SCREEN_WIDTH or RenderSet['ball'].x <= 0:
                    if RenderSet['ball'].x >= SCREEN_WIDTH:
                        #right
                        BALLVECTOR[0] = -BALLVECTOR[0]
                    if RenderSet['ball'].x <= 0:
                        #left
                        BALLVECTOR[0] = -BALLVECTOR[0]
                    # Send message
    ...
    def startScreen(self):
        ...
        font_lower = pygame.font.Font('retro.ttf',20)  # Ensure proper read/write perms on this file
    ...
    def waitScreen(self, channel):
        ...
        waiting = True
        LoadingText = ['Connecting to Server', 'Connecting to Server.', 'Connecting to Server..', 'Connecting to Server...', 'Connecting to Server....']
        font = pygame.font.Font('retro.ttf',48)  
